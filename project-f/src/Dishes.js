        ...
        <div className='DishList'>
        {
          fetchDishes.map((dish, index)=>
            ...
            <Card className="bg-dark text-white Card" onClick={() => {setShowDishModalShow(true); setShowDishModalInfo(dish)}}>
              <Card.Img src={`/uploads/${dish.img}`} alt="Card image" style={{height: '200px', width: '300px'}}/>
              <Card.ImgOverlay>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" className="bi bi-three-dots-vertical" viewBox="0 0 16 16" fill='white'>
